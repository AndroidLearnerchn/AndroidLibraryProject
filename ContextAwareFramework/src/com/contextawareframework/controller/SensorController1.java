...
public class SensorController1 {
	...
	private static SensorController1 controller;
	 ...
	 */
	private SensorController1(Context context)
	{
	 ...
	 */
	public static synchronized SensorController1 getInstance(Context context)
	{
		if (controller == null)
			controller = new SensorController1(context);
