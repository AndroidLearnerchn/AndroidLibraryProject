...
public class ContextAwareSQLiteHelper extends SQLiteOpenHelper {
	...
	//public static final String COLUMN_LIGHT_y= "y_value";
	//public static final String COLUMN_LIGHT_Z= "z_value";
	...
	*/
	...
	public void onCreate(SQLiteDatabase database)
	{
		try
		{
			if(GlobalVariable.SENSOR_ACCELEROMETER_TABLE)
			{
				database.execSQL(CREATE_TABLE_ACCELEROMETER);
			}
			if(GlobalVariable.SENSOR_BATTERY_TABLE)
			{
				database.execSQL(CREATE_TABLE_BATTERY);
			}
			if(GlobalVariable.SENSOR_LIGHT_TABLE)
			{
				database.execSQL(CREATE_TABLE_LIGHT);
			}
			if(GlobalVariable.SENSOR_PROXIMITY_TABLE)
			{	
				database.execSQL(CREATE_TABLE_PROXIMITY);
			}
			if(GlobalVariable.SENSOR_LOCATION_TABLE)
			{
				database.execSQL(CREATE_TABLE_LOCATION);
			}
			if(GlobalVariable.SENSOR_USERINFO_TABLE)
			{
