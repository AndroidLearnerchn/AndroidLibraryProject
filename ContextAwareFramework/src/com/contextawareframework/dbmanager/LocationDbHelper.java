...
public class  LocationDbHelper{
  ...
  private String[] allColumns = { 
		  ...
		  ContextAwareSQLiteHelper.COLUMN_HANGOUT_INFO };
...
//  }
 ...
 public LocationPojo createComment(String timestamp,String value1, String value2, String value3, String value4)
 {
	    ContentValues values = new ContentValues();
	    ...
	    values.put(ContextAwareSQLiteHelper.COLUMN_HANGOUT_INFO, value4);    	        
...
//Till here 
  ...
  private LocationPojo cursorToComment(Cursor cursor) 
  {
      ...
      location.setHangoutinfo(cursor.getString(4));
